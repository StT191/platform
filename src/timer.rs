...
impl NormInterval {
    ...
    #[inline] pub fn new(duration: Duration) -> Self {
        Self { instant: Instant::now(), duration }
    }

    #[inline] pub fn from_secs(duration_secs: f64) -> Self {
        Self::new(Duration::from_secs_f64(duration_secs))
    }

    #[inline] pub fn elapsed(&self, instant: Instant) -> f64 {
    ...
    #[inline] pub fn advance_by(&mut self, times: f64) {
    ...
    #[inline] pub fn advance_by_full_elapsed(&mut self, instant: Instant) -> f64 {
...
impl StepInterval {
    ...
    #[inline] pub fn elapsed(&self, instant: Instant) -> i64 {
    ...
    #[inline] pub fn step_by(&mut self, times: i64) {
    ...
    #[inline] pub fn step_if_elapsed(&mut self, instant: Instant) -> i64 {
        let elapsed = self.elapsed(instant);
        if elapsed >= 1 { self.step_by(elapsed) }
        elapsed
    }

    #[inline] pub fn step_next(&mut self, instant: Instant) -> i64 {
        let elapsed = self.elapsed(instant);
...
impl IntervalCounter {
    ...
    #[inline] pub fn add(&mut self) {
        self.count += 1;
    }

    #[inline] pub fn count(&mut self) -> Option<IntervalCount> {
