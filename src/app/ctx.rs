...
pub struct AppCtx {
  ...
  #[cfg(feature = "frame_pacing")] set_frame_duration: Option<Duration>,
...
impl AppCtx {
  ...
  fn update_frame_duration(&mut self) {
    self.frame_duration = self.set_frame_duration.or(self.monitor_frame_duration).unwrap_or(STD_FRAME_DURATION);
  }

  #[cfg(feature = "frame_pacing")]
  pub fn set_frame_duration(&mut self, set_duration: Option<Duration>) {
    self.set_frame_duration = set_duration;
    self.update_frame_duration();
  }

  #[cfg(feature = "frame_pacing")]
  pub fn fetch_monitor_frame_duration(&mut self) {
  ...
  pub(super) fn new(event_loop_proxy: AppEventLoopProxy, window: Window) -> Self {
    ...
    let mut app_ctx = Self {
      ...
      #[cfg(feature = "frame_pacing")] set_frame_duration: None,
